...
public class SQLHelper {
	 ...
	 * @return
	 */
	public static String row_page_after(int pagesize, int pageindex,
			String orderby, String asc) {
		StringBuilder sb = new StringBuilder();
		sb.append(" order by ").append(orderby).append(" ").append(asc)
				.append(" LIMIT ").append((pageindex - 1) * pagesize)
	 ...
	 * @return
	 */
	public static String row_select(String table, String load_ziduans[],
			String[] conditions, String after) {
		StringBuilder sb = new StringBuilder();
		sb.append("select ");
	...
	public static String row_select(String table, String load_ziduans_dot,
			String conditions, String after) {
		return row_select(table, StringUtils.Split(load_ziduans_dot, DOT),
				StringUtils.Split(conditions, DOT), after);
	}
	 ...
	 * @return
	 */
	public static String row_delete(String table, String[] conditions,
			String after) {
		StringBuilder sb = new StringBuilder();
	 ...
	 * @return
	 */
	public static String rows_delete(String table, String in_key,
			String[] in_vals, String after) {
		StringBuilder sb = new StringBuilder();
		sb.append("delete from ");
		sb.append(table).append(" where ").append(in_key).append(" in('")
				.append(StringUtils.join(in_vals, "','")).append("')");
		if (after != null)
			sb.append(" ").append(after);
		return sb.toString();
	}
	 ...
	 * @return
	 */
	public static String row_insert(String table, String[] insert_ziduans,
			String after) {
		StringBuilder sb = new StringBuilder();
		sb.append("insert into ");
		sb.append(table);
		sb.append("(").append(StringUtils.join(insert_ziduans, ","))
				.append(") values(");
	...
	public static String row_insert(String table, String insert_ziduans_dot,
			String after) {
		return row_insert(table, StringUtils.Split(insert_ziduans_dot, DOT),
				after);
	}
	 ...
	 * @return
	 */
	public static String row_insert(String table, int insert_ziduans_length,
			String after) {
		StringBuilder sb = new StringBuilder();
		sb.append("insert into ");
	 ...
	 * @return
	 */
	public static String row_update(String table, String[] update_ziduans,
			String[] conditions, String after) {
		StringBuilder sb = new StringBuilder();
		sb.append("update ");
		sb.append(table);
		sb.append(" set ").append(StringUtils.join(update_ziduans, "=?,"))
	...
	public static String row_update(String table, String update_ziduans_dot,
			String conditions, String after) {
		return row_update(table, StringUtils.Split(update_ziduans_dot, DOT),
				StringUtils.Split(conditions, DOT), after);
	}
